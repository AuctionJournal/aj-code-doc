...
![Verified Bidder overview — Get Instantly Approved for Auctions](../image/bidder/verification-intro.png "Verified Bidder landing screen")
...
![Step 1 — add card (+) and Step 2 preview](../image/bidder/verification-steps-overview.png "Step 1 payment area with add-card button")
...
![Step 1 — payment form with billing fields and Stripe card input](../image/bidder/verification-step1-payment.png "Payment details form")
...
![Step 2 — Driving Licence or State ID upload (front and back)](../image/bidder/verification-step1-and-step2.png "Identity upload form after card saved")
...
![After verification — manage saved card and ID](../image/bidder/verification-verified-manage.png "Verified bidder manage screen")
